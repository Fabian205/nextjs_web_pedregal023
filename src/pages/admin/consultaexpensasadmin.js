...
function ConsultaExpensasAdmin() {
  return (
    <div className="bg-gray-700 h-screen bg-cover bg-no-repeat bg-center bg-fixed flex flex-col mt-20 items-center relative">
      <h1 className="text-white text-xl">A D M I N I S T R A D O R</h1>
      <h1 className="text-white text-xl">CONSULTA DE EXPENSAS</h1>
      <div>
...
export default ConsultaExpensasAdmin;
