    ...
    <div className='bg-[url("/img01.jpg")] h-screen bg-cover bg-no-repeat bg-center bg-fixed flex items-center relative'>
      ...
      <div className="container mx-auto px-4 z-10">
        <div className="text-center text-white flex flex-col gap-[20px] md:gap-[40px]">
          ...
          <div>
            <h1 className="text-2xl md:text-3xl lg:text-5xl font-semibold tracking-wider"><span className="text-green-700">Home</span> Very Easily</h1>
          </div>
      ...
      <div className=" hidden absolute right-20 top-32 z-10 md:flex flex-col gap-5 items-center">
        ...
        <Link legacyBehavior href="https://www.facebook.com/profile.php?id=100092156511987"><a target="_blank"><BsFacebook size={25} className="text-green-700 hover:-translate-x-1.5 duration-300"/></a></Link>
